...
CalcWindow::CalcWindow ()
{
  ...
  add_control_button ("^", 1, 0, 1, 1, GREEN);
  add_control_button ("<", 0, 1, 1, 1, GREEN);
  add_control_button (">", 3, 1, 1, 1, GREEN);
  add_control_button ("v", 1, 4, 1, 1, GREEN);
  ...
  grid_add_button ("x²", 3, 3, LIGHT_BLUE, nullptr);
