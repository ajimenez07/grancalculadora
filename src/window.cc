...
CalcWindow::CalcWindow ()
{
  ...
  grid_add_button ("(", 1, 0, LIGHT_BLUE,
                   [this] () { m_display->insert_symbol ("("); });
  grid_add_button (")", 2, 0, LIGHT_BLUE,
                   [this] () { m_display->insert_symbol (")"); });
  grid_add_button ("π", 3, 0, LIGHT_BLUE,
                   [this] () { m_display->insert_symbol ("π"); });
  grid_add_button ("xʸ", 4, 0, LIGHT_BLUE,
                   [this] () { m_display->insert_power (); });

  grid_add_button ("7", 0, 1, NAVY_BLUE,
                   [this] () { m_display->insert_symbol ("7"); });
  grid_add_button ("8", 1, 1, NAVY_BLUE,
                   [this] () { m_display->insert_symbol ("8"); });
  grid_add_button ("9", 2, 1, NAVY_BLUE,
                   [this] () { m_display->insert_symbol ("9"); });
  ...
  grid_add_button ("4", 0, 2, NAVY_BLUE,
                   [this] () { m_display->insert_symbol ("4"); });
  grid_add_button ("5", 1, 2, NAVY_BLUE,
                   [this] () { m_display->insert_symbol ("5"); });
  grid_add_button ("6", 2, 2, NAVY_BLUE,
                   [this] () { m_display->insert_symbol ("6"); });
  ...
  grid_add_button ("1", 0, 3, NAVY_BLUE,
                   [this] () { m_display->insert_symbol ("1"); });
  grid_add_button ("2", 1, 3, NAVY_BLUE,
                   [this] () { m_display->insert_symbol ("2"); });
  grid_add_button ("3", 2, 3, NAVY_BLUE,
                   [this] () { m_display->insert_symbol ("3"); });
  grid_add_button ("⌫", 3, 3, LIGHT_BLUE, [this] () { m_display->erase (); });
  grid_add_button ("□/□", 4, 3, LIGHT_BLUE,
                   [this] () { m_display->insert_fraction (); });

  grid_add_button ("0", 0, 4, NAVY_BLUE,
                   [this] () { m_display->insert_symbol ("0"); });
  grid_add_button (".", 1, 4, LIGHT_BLUE,
                   [this] () { m_display->insert_symbol ("."); });
  grid_add_button ("=", 2, 4, 3, 1, GREEN,
                   [this] () { m_display->show_result (); });

  grid_add_button ("^", 0, 5, 1, 1, GREEN,
                   [this] () { m_display->move_up (); });
  grid_add_button ("<", 1, 5, 1, 1, GREEN,
                   [this] () { m_display->move_left (); });
  grid_add_button ("v", 2, 5, 1, 1, GREEN,
                   [this] () { m_display->move_down (); });
  grid_add_button (">", 3, 5, 2, 1, GREEN,
                   [this] () { m_display->move_right (); });
